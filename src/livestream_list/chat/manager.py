...
class ChatManager(QObject):
    ...
    def open_chat(self, livestream: Livestream) -> None:
        ...
        # YouTube, Chaturbate, and TikTok use embedded web views — no native connection
    ...
    def send_message(
        ...
        # Kick echoes via Pusher websocket, YouTube/Chaturbate/TikTok use web views.
    ...
    def _create_connection(self, platform: StreamPlatform) -> BaseChatConnection | None:
        ...
        if platform == StreamPlatform.TWITCH:
            ...
            from .connections.tiktok import TikTokChatConnection

            return TikTokChatConnection(parent=self)
        return None
